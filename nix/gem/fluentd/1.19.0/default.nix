...
stdenv.mkDerivation {
  ...
  installPhase = ''
        ...
        mkdir -p $dest/gems/fluentd-1.19.0
        cp -r . $dest/gems/fluentd-1.19.0/
        mkdir -p $dest/specifications
        cat > $dest/specifications/fluentd-1.19.0.gemspec <<'EOF'
