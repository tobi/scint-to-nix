...
stdenv.mkDerivation {
  ...
  src = builtins.path {
    path = ./source;
    name = "term-ansicolor-1.11.2-source";
  };
  ...
  installPhase = ''
        ...
        mkdir -p $dest/gems/term-ansicolor-1.11.2
        cp -r . $dest/gems/term-ansicolor-1.11.2/
        mkdir -p $dest/specifications
        cat > $dest/specifications/term-ansicolor-1.11.2.gemspec <<'EOF'
