...
stdenv.mkDerivation {
  ...
  src = builtins.path {
    path = ./source;
    name = "term-ansicolor-1.11.1-source";
  };
  ...
  installPhase = ''
        ...
        mkdir -p $dest/gems/term-ansicolor-1.11.1
        cp -r . $dest/gems/term-ansicolor-1.11.1/
        mkdir -p $dest/specifications
        cat > $dest/specifications/term-ansicolor-1.11.1.gemspec <<'EOF'
