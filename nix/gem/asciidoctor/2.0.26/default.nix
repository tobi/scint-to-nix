...
stdenv.mkDerivation {
  ...
  src = builtins.path {
    path = ./source;
    name = "asciidoctor-2.0.26-source";
  };
  ...
  installPhase = ''
        ...
        mkdir -p $dest/gems/asciidoctor-2.0.26
        cp -r . $dest/gems/asciidoctor-2.0.26/
        mkdir -p $dest/specifications
        cat > $dest/specifications/asciidoctor-2.0.26.gemspec <<'EOF'
