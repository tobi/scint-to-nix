...
[
  ...
  { name = "solid_cable"; version = "3.0.12"; }
  { name = "solid_cache"; version = "1.0.10"; }
  { name = "solid_queue"; version = "1.2.4"; }
  { name = "sqlite3"; version = "2.8.0"; }
  ...
  { name = "turbo-rails"; version = "2.0.21"; }
