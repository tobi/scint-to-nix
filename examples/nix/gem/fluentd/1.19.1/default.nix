...
stdenv.mkDerivation {
  ...
  installPhase = ''
        ...
        mkdir -p $dest/gems/fluentd-1.19.1
        cp -r . $dest/gems/fluentd-1.19.1/
        mkdir -p $dest/specifications
        cat > $dest/specifications/fluentd-1.19.1.gemspec <<'EOF'
