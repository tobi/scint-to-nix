...
if git ? rev then
  gitRevs.${git.rev}
    or (throw "aws-sdk-transcribestreamingservice: unknown git rev '${git.rev}'")
else
  versions.${version}
    or (throw "aws-sdk-transcribestreamingservice: unknown version '${version}'")
